...
public class AccountDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1Cancel.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jButton2Submit.setForeground(new java.awt.Color(0, 0, 0));
    ...
    public Connection getConnection()
    {
        ...
        try
        {
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bank2", "root", "Kittu1311");
    ...
    {
        double Balance = Double.parseDouble(jTextFieldBal1.getText());
        if(Balance< 10000.00){
            JOptionPane.showMessageDialog(this,"TO CREATE AN ACCOUNT THERE SHOULD BE MIN.10000 BALANCE");
        }
        else if (Balance >= 10000.0 && Balance <= 9999999.99) {
            ...
            JOptionPane.showMessageDialog(null, "Invalid balance value. It must be between 10000.00 and 9,999,999.99.");
        }
