...
public class MoneyTransfer1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonProceed.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void jButtonProceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonProceedActionPerformed
         ...
         try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bank2","root","Kittu1311");
            con.setAutoCommit(false);

            Statement stmt;
            stmt=con.createStatement();
            String createTransactionsTableSQL = "CREATE TABLE IF NOT EXISTS Transactions (TransactionID INT AUTO_INCREMENT PRIMARY KEY, Account_no VARCHAR(255), BenificiaryAccount_no VARCHAR(255), Amount DECIMAL(10, 2))";
            ...
            while(rs.next())
            {
                if(Account_no==rs.getInt("Account_Id") )
                { 
                   flag=1;
                }
            ...
            if(flag==1)
            {
              ...
              String sql2="select Balance from Account where Account_Id='"+Account_no+"'";
              rs1=stmt.executeQuery(sql2);
              rs1.next();
              int num1=rs1.getInt("Balance");
              
               String sql3="select Balance from Account where Account_Id='"+BenificiaryAccount_No+"'";
               ...
               String WA="update Account set Balance="+numW+" where Account_Id="+Account_no+"";
             ...
             //  PreparedStatement pst2 ;          
                ...
                String DA="update Account set Balance="+numD+" where Account_Id="+BenificiaryAccount_No+"";
