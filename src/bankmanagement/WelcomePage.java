...
public class WelcomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelClose.setFont(new java.awt.Font("Ubuntu Medium", 1, 24)); 
        ...
        jLabelMin.setFont(new java.awt.Font("Ubuntu Medium", 1, 24)); 
        ...
        jLabel1.setFont(new java.awt.Font("Ubuntu Light", 1, 21)); 
        jLabel1.setForeground(new java.awt.Color(254, 254, 254));
        jLabel1.setText("BANK OF SRMIST, CHENNAI");

        jLabel6.setBackground(new java.awt.Color(236, 240, 241));
        jLabel6.setFont(new java.awt.Font("Ubuntu Light", 1, 36)); 
        jLabel6.setForeground(new java.awt.Color(254, 254, 254));
        jLabel6.setText("WELCOME");

        jButton1.setBackground(new java.awt.Color(1, 1, 1));
        jButton1.setFont(new java.awt.Font("Ubuntu Medium", 1, 14)); 
        ...
        jButtonSignup.setFont(new java.awt.Font("Ubuntu Medium", 1, 14)); 
        jButtonSignup.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void jButtonSignupMouseClicked(java.awt.event.MouseEvent evt) {
