...
public class DetailsInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonPersonal.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jButtonMoneytransfer.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jButtonAccount1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jButtonLoan.setBackground(new java.awt.Color(5, 1, 0));
        jButtonLoan.setFont(new java.awt.Font("Ubuntu Medium", 1, 14));
        jButtonLoan.setForeground(new java.awt.Color(0, 0, 0));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jButtonAccount1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jButtonMoneytransfer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jButtonLoan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))  // Add this line for the "LOAN" button
                        .addGap(188, 188, 188))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addComponent(jButtonLogOut)
                        .addGap(46, 46, 46))))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jButtonMoneytransfer)
                .addGap(30, 30, 30)
                .addComponent(jButtonLoan)  // Add this line for the "LOAN" button
                .addGap(30, 30, 30)
                .addComponent(jButtonLogOut)
                .addContainerGap(24, Short.MAX_VALUE))
        );
    ...
    private void jButtonMoneytransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMoneytransferActionPerformed
        ...
        try
        {
            Connection mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/bank2","root","Kittu1311");
            String s1="";
            String y="Select Account_Id from Account where Aadhar_no= (select Aadhar_no from Customer where Username='"+u+"' )";
            // Statement st=mycon.createStatement();
            PreparedStatement p=mycon.prepareStatement(y);
            ResultSet r=p.executeQuery();
            if(r.next())
            {
                s1=r.getString("Account_Id");
            }
            mf.set(s1);
        }
        catch(Exception e)
    ...
    private void jButtonLoanActionPerformed(java.awt.event.ActionEvent evt) {
        // Launch the Loan Calculator App
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                LoanCalculator.main(new String[]{});
            }
        });
    }
